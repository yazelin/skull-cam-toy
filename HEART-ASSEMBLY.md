...
- 列印描圖:印 [`cut/heart-cut-A4.pdf`](cut/heart-cut-A4.pdf)(兩張 A4、1:1),縮放選「實際大小 / 100%」,**不要**選「符合頁面」。雷切:用 [`heart-cut-1.svg`](cut/heart-cut-1.svg) 或 [`heart-cut-1.dxf`](cut/heart-cut-1.dxf),黑線=切割、藍字=刻字。
- 印出後量左下角校正尺:**50mm 線段必須剛好 50mm**,不對就調印表機縮放重印。
- 材料:3mm 木板或厚紙板兩張 A4 的量、Ø6 圓棒兩段(軸 92mm、手把 34mm;竹筷可替代,骷髏頭實作就是竹筷)、白膠、砂紙、一張紙條(第 5 步當墊片用)。
