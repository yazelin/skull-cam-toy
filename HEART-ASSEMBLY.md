...
一根手搖軸、一片偏心凸輪、一顆會跳的心。18 片 3mm 板 + 兩段 Ø6 圓棒,升程 12mm。
...
- 列印描圖:印 [`cut/heart-cut-A4.pdf`](cut/heart-cut-A4.pdf)(A4、1:1),縮放選「實際大小 / 100%」,**不要**選「符合頁面」。雷切:用 [`heart-cut-1.svg`](cut/heart-cut-1.svg) 或 [`heart-cut-1.dxf`](cut/heart-cut-1.dxf),黑線=切割、藍字=刻字。
- 印出後量左下角校正尺:**50mm 線段必須剛好 50mm**,不對就調印表機縮放重印。
- 材料:3mm 木板或厚紙板一張 A4、Ø6 圓棒兩段(軸 92mm、手把 34mm;竹筷可替代,骷髏頭實作就是竹筷)、白膠、砂紙、一張紙條(第 5 步當墊片用)。
...
兩片側板(有 Ø6.2 軸孔的)立在底板上:距底板**左緣 20mm、右緣 4mm**,軸孔同高同向,黏牢。
